...
class ContactRecordsControllerTest < ActionController::TestCase
  ...
  test "should create contact_record" do
    assert_difference('ContactRecord.count') do
      post :create, contact_record: { customer_id: @contact_record.customer_id, description: @contact_record.description, employee_id: @contact_record.employee_id, time: @contact_record.time }
    end
  ...
  test "should update contact_record" do
    patch :update, id: @contact_record, contact_record: { customer_id: @contact_record.customer_id, description: @contact_record.description, employee_id: @contact_record.employee_id, time: @contact_record.time }
    assert_redirected_to contact_record_path(assigns(:contact_record))
  end
