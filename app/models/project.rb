class Project < ActiveRecord::Base
  ...
  filter_where_keys [:project_type, :project_level, :project_state, :create_unit, :endowment, {create_date: {type: :time}}, {name: {op: :like, split: true}}]
  filter_scoped_orders [:total_amount, :order_by_actual_amount, :create_date, :rest_amount, :necessary_date]
  filter_virtual_columns [:total_amount, :rest_amount, :necessary_date]
