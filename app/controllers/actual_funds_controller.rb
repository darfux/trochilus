class ActualFundsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fund.save
        format.html { redirect_to [@donation_record_actual.project, @donation_record_actual], notice: 'Fund was successfully created.' }
      else
  ...
  def update
    ...
    respond_to do |format|
      if @fund.update_attributes(fund_params)
        format.html { redirect_to [@donation_record_actual.project, @donation_record_actual], notice: 'Fund was successfully updated.' }
